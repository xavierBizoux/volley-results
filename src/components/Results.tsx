...
const Results = ({ data, filter }: Props) => {
    ...
    return (
        <ul className='flex flex-col w-full gap-2 text-l'>
            {filteredData &&
                    ...
                    return (
                        <li
                            ...
                            <div className='flex flex-row w-full'>
                                <div className='flex flex-row justify-start items-center w-2/5 gap-4'>
                                    <img
                                        src={game.team1.pic}
                                ...
                                <div className='flex flex-row items-center justify-end w-2/5 gap-4 '>
